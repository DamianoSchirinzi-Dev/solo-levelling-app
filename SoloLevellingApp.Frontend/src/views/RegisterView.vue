  ...
  >
    <div class="max-w-md w-full bg-gray-800 rounded-xl shadow-lg p-8">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-400">Join us and get started today</p>
      </div>
      ...
      <form @submit.prevent="register" class="space-y-6">
        ...
        <div>
          ...
          <div class="relative">
            <input
              ...
              class="w-full px-4 py-3 border border-gray-700 bg-gray-900 text-white rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200 pl-11"
              :class="{
        ...
        <div>
          ...
          <div class="relative">
            <input
              ...
              class="w-full px-4 py-3 border border-gray-700 bg-gray-900 text-white rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200 pl-11 pr-11"
              :class="{
                'border-red-500 focus:ring-red-500 focus:border-red-500':
                  passwordError,
              }"
        ...
        <div class="flex items-start">
          <input
            ...
            v-model="acceptTerms"
            type="checkbox"
            class="h-4 w-4 text-purple-500 focus:ring-purple-500 border-gray-700 rounded mt-1"
          />
        ...
        <p v-if="termsError" class="text-sm text-red-400">{{ termsError }}</p>
        ...
        <button
          ...
          class="w-full bg-purple-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
        >
...
watch(username, validateFullName);
